...
export const LandingPage = ({ onStart }: LandingPageProps) => {
    return (
        <div className="fixed inset-0 z-[100] bg-[#0a0f1c] text-white overflow-y-auto">
            {/* Background Ambience */}
            ...
            <div className="relative z-10 min-h-full flex flex-col justify-center items-center px-6 py-20">
